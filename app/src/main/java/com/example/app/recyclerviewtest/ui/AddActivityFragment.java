...
import com.example.app.recyclerviewtest.adapter.AddRemoveAdapter;
...
public class AddActivityFragment extends Fragment
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //adapter
        final AddRemoveAdapter myItemAdapter = new AddRemoveAdapter(mRecyclerViewExpandableItemManager, getDataProvider());

        mAdapter = myItemAdapter;
        mFab = ((AddActivity)getActivity()).getFab();
    ...
    public AddRemoveProvider getDataProvider() {
        return ((AddActivity) getActivity()).getDataProvider();
    }
}
