...
public class MainActivityFragment extends Fragment implements
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        //adapter
        final EDSAdapter myItemAdapter = new EDSAdapter(mRecyclerViewExpandableItemManager, getDataProvider());
        ...
        if (supportsViewElevation()) {
            ...
            mRecyclerView.addItemDecoration(new ItemShadowDecorator((NinePatchDrawable)
                    ContextCompat.getDrawable(getContext(), R.drawable.material_shadow_z3)));
        }
